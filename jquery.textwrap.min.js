...
c.appendChild(b.cloneNode(true));b.parentNode.replaceChild(c,b);c=1}}else if(b.nodeType==1&&b.childNodes&&!a.skip.test(b.tagName)&&b.className.indexOf(a.klass)==-1)for(d=0;d<b.childNodes.length;++d)d+=h(b.childNodes[d]);return c},i=function(b){f("."+a.reset,b).each(function(){var c=f(this).text();c=document.createTextNode(c);this.parentNode.replaceChild(c,this)})};return this.each(function(){g&&f.extend(a,g);if(typeof a.skip=="string")a.skip=new RegExp("("+a.skip.split(",").join("|")+")","i");if(a.match&&
typeof a.match=="string")a.match=new RegExp(a.match,"i");f.trim(a.reset)&&i(this);a.match&&h(this)})}})(jQuery);
